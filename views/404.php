...
<?php
    ...
    includeWithVariables('..\DiscoverDrink\components\header.php', array("class" => "404")); // set to name of page - only search, drinks & bars will highlight their respective links
