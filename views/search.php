...
<html>
    ...
    <body>
<?php
    includeWithVariables('..\Discover Drink\components\header.php', array("class" => "search")); // set to name of page - only search, drinks & bars will highlight their respective links
