...
<?php
    ...
    includeWithVariables('..\DiscoverDrink\components\header.php', array("class" => "home")); // set to name of page - only search, drinks & bars will highlight their respective links
