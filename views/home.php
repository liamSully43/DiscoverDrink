...
<html>
    <head>
        ...
        <link media="(max-width: 1000px)" href='../CSS/home-mobile.css' type='text/css' rel='stylesheet' />
        <!-- Google Fonts -->
...
<?php
    ...
    <section class="text">
        ...
        <p>The all new Discover Drink website offers you the ability to search for your favourite alcohol, bars or clubs</p>
    </section>
    <section class="search">
    <?php
        includeWithVariables('..\Discover Drink\components\searchbar.php', array("path" => "", "class" => "dark"), true); // set to page directory - "search" for all pages except the drinks page where it is "drink"
    ?>
    </section>
