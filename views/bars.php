...
<?php
    ...
    includeWithVariables('..\DiscoverDrink\components\header.php', array("class" => "bars")); // set to name of page - only search, drinks & bars will highlight their respective links
